...
import { BorderBeam } from "@/components/portfolio-layout/ui/lightswind/border-beam";
    ...
    return (
        <AnimatePresence>
            {showHeader && (
                ...
                >
                    <div
                        className="border border-gray-200 dark:border-gray-800 backdrop-blur-xl bg-white/70 dark:bg-black/50
            w-full xl:max-w-4xl rounded-full
                    ...
                    <AnimatePresence>
                        {isMobileMenuOpen && (
                            <motion.div
                                ...
                                className="fixed inset-0 z-40 backdrop-blur-xl bg-white/30 dark:bg-black/50 md:hidden flex flex-col items-center justify-center border border-white/20 dark:border-white/10"
                            >
