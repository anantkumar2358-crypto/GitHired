    ...
    return (
        ...
        >
            <motion.div
                ...
                className={`absolute bottom-2 left-1/2 -translate-x-1/2 transform flex items-end gap-4 w-fit border-2 border px-4 pb-2 backdrop-blur-md ${className}`}
                style={{ height: panelHeight, borderRadius: "30px" }}
                role="toolbar"
