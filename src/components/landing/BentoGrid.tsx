...
function FeatureCard({ feature, index }: { feature: typeof features[0], index: number }) {
    ...
    return (
        ...
        hover:scale-105 transition-transform duration-300 cursor-pointer shadow-xl
      `}
        >
            <div className="relative z-10 h-full flex flex-col">
                ...
                <h3 className="text-2xl mb-3 font-bold">{feature.title}</h3>
      ...
      `}
        >
            <div className="relative z-10 flex items-start gap-4">
                ...
                <div>
                    <h4 className="text-xl mb-2 font-bold">{feature.title}</h4>
